...
{
    public partial class block_categoryrelate : DGCUserControl
    {
        #region Parameter
        ...
        {
            lst = pcBll.GetListRelate(LangInt, pageName, string.Empty, cid, currentPageIndex, DBConvert.ParseInt(ConfigurationManager.AppSettings["pageSizeBlogLeture"]), out  total);
            //if (cid.Contains("@"))
            //{
        ...
        protected void rptResult_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                img.Alt = img.Attributes["title"] = ltrBrief.Text = data.ProductDesc.Title;
