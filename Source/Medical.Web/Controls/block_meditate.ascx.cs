...
{
    public partial class block_meditate : DGCUserControl
    {
        #region Parameter
        ...
        private void GetDetail()
        {
            ...
            lst = pcBll.GetList(LangInt, string.Empty, "1", ConfigurationManager.AppSettings["parentIdMeditate"], string.Empty, 1, 3, out  total);
