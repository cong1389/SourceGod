...
{
    public partial class block_translatedbook : DGCUserControl
    {
        #region Parameter
        ...
        private void GetDetail()
        {
            ...
            lst = pcBll.GetList(LangInt, string.Empty, "1", ConfigurationManager.AppSettings["parentIdTranslatedBook"], string.Empty, 1, 3, out  total);
        ...
        protected void rptResult_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                hypImg.Title = ltrBrief.Text = img.Alt = img.Attributes["title"] = data.ProductDesc.Title;
