<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_managementid.ascx.cs"
    Inherits="Cb.Web.Admin.Pages.ManagementID.admin_managementid" %>
<%@ Register Namespace="Cb.WebControls" Assembly="Cb.WebControls" TagPrefix="cc" %>
<script language="javascript" type="text/javascript">
    function submitButton(task) {
        var frm = document.getElementById('aspnetForm');
        //alert(task);
        if (task == 'new' || task == 'search' || task == 'save' || checkSelectedItem('<%=msg_no_selected_item%>')) {
            switch (task) {
                case 'delete':
...
<div align="center" class="centermain">
    <div class="main">
        ...
        <table class="adminheading">
            <tr>
                <th class="user">
                    <asp:Literal ID="ltrAdminHeaderName" runat="server" Text="Quản lý ID"></asp:Literal>
                </th>
                <td nowrap="nowrap">
                    &nbsp;
                ...
                <ItemTemplate>
                    <tr id="trList" runat="server">
                        ...
                        <td id="tdName" runat="server">
                            <a href="#">
                                <asp:Literal ID="ltrName" runat="server"></asp:Literal></a>
                        </td>
                        <td>
                            <asp:Literal ID="ltrValue" runat="server" />
                        </td>
                        <td>
