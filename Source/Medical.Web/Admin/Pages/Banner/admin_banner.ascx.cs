...
{
    public partial class admin_banner : DGCUserControl
    {
        ...
        private void add()
        {
            string url = LinkHelper.GetAdminLink("edit_banner");
            Response.Redirect(url);
        }
        ...
        private void edit(string cid)
        {
            ...
            {
                arrStr = cid.Split(',');
                link = LinkHelper.GetAdminLink("edit_banner", arrStr[0]);
            }
            else
                link = LinkHelper.GetAdminLink("edit_banner", cid);
        ...
        {
            saveOrder();
            string url = Utils.CombineUrl(template_path, LinkHelper.GetAdminLink("banner"));
            Response.Redirect(url);
        }
        ...
        protected void rptResult_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                try
                {
                    ...
                    {
                        src = Path.Combine(ConfigurationManager.AppSettings["UploadBanner"], data.Image);
                    ...
                    hdflink.NavigateUrl = template_path + LinkHelper.GetAdminLink("edit_banner", data.Id);
