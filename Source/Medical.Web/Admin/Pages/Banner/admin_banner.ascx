<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_banner.ascx.cs" Inherits="Cb.Web.Admin.Pages.Banner.admin_banner" %>
...
<div align="center" class="centermain">
    <div class="main">
        ...
        <table class="adminheading">
            <tr>
                <th class="user">
                    <asp:Literal ID="ltrAdminHeaderName" runat="server" Text="strHeaderBanner"></asp:Literal>
                </th>
                <td nowrap="nowrap">
                    &nbsp;
