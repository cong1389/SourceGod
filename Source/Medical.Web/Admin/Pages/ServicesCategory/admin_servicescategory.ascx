<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_servicescategory.ascx.cs"
    Inherits="Cb.Web.Admin.Pages.ServicesCategory.admin_servicescategory" %>
...
<div align="center" class="centermain">
    <div class="main">
        ...
        <table class="adminheading">
            <tr>
                <th class="user">
                    <asp:Literal ID="ltrAdminHeaderName" runat="server" Text="strHeaderServicesCategory"></asp:Literal>
                </th>
                <td nowrap="nowrap">
                    <asp:Literal ID="ltrAdminSearch" runat="server" Text="strName"></asp:Literal>
                </td>
                <td>
                    <input type="text" id="search" name="search" class="inputbox" onkeypress="return checkEnter(event)"
                        runat="server" />
                </td>
                <td width="right">
                </td>
