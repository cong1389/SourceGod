...
namespace Cb.WebControls
{
    ...
    public class CKEditorControl : TextBox
    {
        ...
        private string filebrowserImageBrowseUrl = "/ckfinder/ckfinder.html?type=Images";
        private string filebrowserImageUploadUrl = "/Admin/Upload.ashx";
        //private string filebrowserImageUploadUrl = "/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Images";
        #endregion
...
that'll hold the contents. In this way, id specific CSS rules will be enabled.")]
        ...
        [Category("CKEditor Other Settings")]
        [Description(@"The writting direction of the language used to write the editor contents. Allowed values are: 
...
'rtl' - for Right-To-Left languages (like Arabic).")]
        ...
        [Category("CKEditor Other Settings")]
        [Description(@"A comma separated list of plugins that are not related to editor instances. Reserved to plugins that extend the core code only.
...
If configured, the ""Browse Server"" button will appear in Link, Image and Flash dialogs.")]
        ...
        {
            get { return config.filebrowserBrowseUrl; }
            set { config.filebrowserBrowseUrl = value; }
        }
...
If not set, CKEditor will use CKEDITOR.config.filebrowserBrowseUrl.")]
        [DefaultValue("/ckfinder/ckfinder.html?type=Images")]
        public string FilebrowserImageBrowseUrl
        {
            //get { return config.filebrowserImageBrowseUrl; }
            //set { config.filebrowserImageBrowseUrl = value; }
            get
            {
        ...
        [DefaultValue("/Admin/Upload.ashx")]
        //[DefaultValue("/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Images")]
        public string FilebrowserImageUploadUrl
        {
            //get { return config.filebrowserImageUploadUrl; }
            //set { config.filebrowserImageUploadUrl = value; }
            get
            {
            ...
            {
                if (!string.IsNullOrEmpty(value))
                    filebrowserImageUploadUrl = value;
            }
        }
...
if supported, otherwise the CKEDITOR.config.defaultLanguage language is used.")]
        ...
        {
            //get { return config.language; } set { config.language = value; } 
            get
            {
                return language;
            }
...
even if the aligment style is not explicitly applied to the current paragraph in the editor.")]
        ...
        {
            this.config.language = !string.IsNullOrEmpty(this.language) ? this.language : string.Empty;
            this.config.filebrowserImageBrowseUrl = !string.IsNullOrEmpty(this.filebrowserImageBrowseUrl) ? this.filebrowserImageBrowseUrl : string.Empty;
            this.config.filebrowserImageUploadUrl = !string.IsNullOrEmpty(this.filebrowserImageUploadUrl) ? this.filebrowserImageUploadUrl : string.Empty;
